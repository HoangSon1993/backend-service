...
public class Global {
    ...
    /**
     * Handle exception when invalid data
     *
     ...
     */
    @ExceptionHandler({
            ConstraintViolationException.class, MissingServletRequestParameterException.class, MethodArgumentNotValidException.class
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "400", description = "Bad Request",
                    content = {@Content(mediaType = APPLICATION_JSON_VALUE, examples = {
                            @ExampleObject(
                                    name = "Handle e when data invalid. (@RequestBody, @RequestParam, @PathVariable)",
    ...
    /**
     * Handler exception when request not found data
     * @param e {@link  Exception}
     * @param request {@link WebRequest}
     * @return {@link ErrorResponse}
     */
